...
const OrdersPageShared = () => {
  ...
  const sortedOrders = useMemo(() => {
    return [...orders].sort((a, b) => {
      const aDone = ["DELIVERED", "CANCELLED"].includes(a.status);
      const bDone = ["DELIVERED", "CANCELLED"].includes(b.status);
  ...
  return (
    <>
      <div className="max-w-6xl mx-auto px-2 py-10 space-y-6">
        ...
        {loadingData && <p className="text-center">Loading orders...</p>}
...
export default OrdersPageShared;